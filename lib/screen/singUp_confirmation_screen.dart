      ...
      child: Column(
        children: [
          Padding(
            ...
            child: SvgPicture.asset('assets/Feito.svg', height: 100,)
          ),
          Padding(
          ...
          Container(
            ...
            child: Text('Tudo certo, o seu cadastro foi realizado com sucesso! Acogora é só aproveitar bastante o aplicativo :)',
          ...
          Padding(
            ...
            child: Container(
              ...
              child: RaisedButton(
                  ...
                  onPressed: () {
                    Navigator.push(context,MaterialPageRoute(builder: (context) => SingUpConfirmation()));
                  },
